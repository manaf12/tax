...
__decorate([
    (0, typeorm_1.Column)('simple-array', { default: [UserRole.USER] }),
...
__decorate([
    (0, typeorm_1.OneToMany)(() => password_reset_token_entity_1.PasswordResetToken, (prt) => prt.user),
    __metadata("design:type", Array)
], User.prototype, "passwordResetTokens", void 0);
__decorate([
    (0, typeorm_1.OneToOne)(() => client_profile_entity_1.ClientProfile, (profile) => profile.user),
